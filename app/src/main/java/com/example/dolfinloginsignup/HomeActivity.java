...
public class HomeActivity extends AppCompatActivity {
        ...
        TextView TVName3,TVEmail2,TVPhnNum2,TVPassword2, TVTotalExpense, TVTotalIncome, TVBalance;
        ImageView BtnAdd;

        private RecyclerView expenseRecycler;
        ExpenseAdapter adapter; // Create Object of the Adapter class
        ...
        public void passUserData(){
            String userName = TVName3.getText().toString().trim();
        ...
        checkUserDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    Intent intent = new Intent(HomeActivity.this, WiseWallet.class);
                    intent.putExtra("name", nameFromDB);
                    intent.putExtra("email", emailFromDB);
                    intent.putExtra("phoneNum", phnNumFromDB);
                    intent.putExtra("password", passwordFromDB);
