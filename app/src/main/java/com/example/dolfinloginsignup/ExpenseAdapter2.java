...
public class ExpenseAdapter2 extends FirebaseRecyclerAdapter<
        ExpenseInfo, ExpenseAdapter2.ExpenseInfoViewholder> {

    public ExpenseAdapter2(
                                    ...
                                    int position, @NonNull ExpenseInfo model)
    {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.homeActivity2, editExpenseFragment).addToBackStack(null).commit();
    ...
    public ExpenseInfoViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new ExpenseAdapter2.ExpenseInfoViewholder(view);
    }
