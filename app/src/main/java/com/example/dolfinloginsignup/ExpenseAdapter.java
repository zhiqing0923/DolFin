...
public class ExpenseAdapter extends FirebaseRecyclerAdapter<
        ExpenseInfo, ExpenseAdapter.ExpenseInfoViewholder> {
    ...
    public ExpenseInfoViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new ExpenseAdapter.ExpenseInfoViewholder(view);
    }
